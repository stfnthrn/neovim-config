...
_G.packer_plugins = {
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/stefan/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
